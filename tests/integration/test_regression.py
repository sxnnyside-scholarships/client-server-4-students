...
def test_regression_auth_brute_force_drop(server_backend: ServerBackend):
    ...
    try:
        proto.send_message(CMD_AUTH, "testuser", "badpass")
        proto.recv_message()
        assert False, "Socket should have been closed"
...
def test_regression_mid_transfer_disconnect_does_not_crash(qtbot, server_backend: ServerBackend, client_backend: ClientBackend, tmp_path):
    """
